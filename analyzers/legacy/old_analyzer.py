# 참조용 보존. 이 파일은 어디서도 import하지 않는다.
# 신규 로직은 analyzers/pass1_runner.py + analyzers/pass2_runner.py 참조.
#
# 구 구현: gpt-4o 단일 패스, 마크다운 텍스트 반환, 스키마 검증 없음.
# 보존 이유: 신 구현과 출력 품질 비교 시 기준선(baseline)으로 사용.

"""
Step 4 (구버전): OpenAI API로 카테고리별 배치 분석 후 리포트 저장.
"""
import json
import os
